...
export const KeyboardScroll = memo(function KeyboardScroll() {
  ...
  const [data, setData] = useState<Data[]>([
    {id: '1', name: 'bob', color: color.warning},
    {id: '2', name: 'bill', color: color.success},
    {id: '3', name: 'jill', color: color.primary},
    {id: '4', name: 'steve', color: color.brand},
  ]);
      ...
      <KeyboardAwareScrollView
        ...
        <View
          ...
          <RecyclerFlatList
            ...
            onRef={listRef}
            onRefetch={onRefetch}
            onRowRender={onRowRender} // TODO: figure out typing of data
